...
public class PhysicsActor extends Actor {
	...
	@Override
	public float getX() {
		return physicsBody.getPosition().x * KgeRuntime.PTM_RATIO;
	}

	@Override
	public float getY() {
		return physicsBody.getPosition().y * KgeRuntime.PTM_RATIO;
	}

	@Override
	public void setX(float x) {
		physicsBody.setTransform(x / KgeRuntime.PTM_RATIO, getY(),
				physicsBody.getAngle());
	}

	@Override
	public void setY(float y) {
		physicsBody.setTransform(getX(), y / KgeRuntime.PTM_RATIO,
				physicsBody.getAngle());
	}

	@Override
	public void setPosition(float x, float y) {
		physicsBody.setTransform(x / KgeRuntime.PTM_RATIO, y / KgeRuntime.PTM_RATIO,
				physicsBody.getAngle());
	}
