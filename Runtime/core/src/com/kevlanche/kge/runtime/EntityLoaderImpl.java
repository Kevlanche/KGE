...
import com.kevlanche.kge.runtime.entity.BasePhysicsEntity;

public class EntityLoaderImpl implements EntityLoader {

	private final World mWorld;

	public EntityLoaderImpl(World world) {
		mWorld = world;
	}
	...
	private class BuilableEntity extends BasePhysicsEntity {

		private final String mName;

		public BuilableEntity(String className, Entity parent) {
			super(className, parent, mWorld);
